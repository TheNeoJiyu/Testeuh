...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/09/09 13:43:28 by antolefe          #+#    #+#             */
/*   Updated: 2024/09/09 13:47:06 by antolefe         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	ft_printf("%x %x %x %X %X %X %c", 1, 125, 2147483647, -1, -125, -2147483647,
		'\n');
	res1 = ft_printf("Hello %c%c%c%c%c\n", 'w', 'o', 'r', 'l', 'd');
	res2 = printf("Hello %c%c%c%c%c\n", 'w', 'o', 'r', 'l', 'd');
	printf("ft_printf: %d, printf: %d\n", res1, res2);
	res1 = ft_printf("Hello %c %c %c %c %c\n", '1', '2', '3', '4', '5');
	res2 = printf("Hello %c %c %c %c %c\n", '1', '2', '3', '4', '5');
	printf("ft_printf: %d, printf: %d\n", res1, res2);
	res1 = ft_printf("salut %s\n", "ca va?");
	res2 = printf("salut %s\n", "ca va?");
	printf("ft_printf: %d, printf: %d\n", res1, res2);
	res1 = ft_printf("salut %s %s\n", "ca va?", "Oui et toi?");
	res2 = printf("salut %s %s\n", "ca va?", "Oui et toi?");
	printf("ft_printf: %d, printf: %d\n", res1, res2);
	res1 = ft_printf("les pointer %p %p %p %p %p\n", (void *)"14", (void *)"24",
			(void *)"168", (void *)"0", (void *)str);
	res2 = printf("les pointer %p %p %p %p %p\n", (void *)"14", (void *)"24",
			(void *)"168", (void *)"0", (void *)str);
	printf("ft_printf: %d, printf: %d\n", res1, res2);
	res1 = ft_printf("%d %d %d %i %i %i\n", 1, 125, 2147483647, -1, -125,
			-2147483647);
	res2 = printf("%d %d %d %i %i %i\n", 1, 125, 2147483647, -1, -125,
			-2147483647);
	printf("ft_printf: %d, printf: %d\n", res1, res2);
	res1 = ft_printf("%u %u %u %u %u %u\n", 1, 125, 2147483647, (unsigned)-1,
			(unsigned)-125, (unsigned)-2147483647);
	res2 = printf("%u %u %u %u %u %u\n", 1, 125, 2147483647, (unsigned)-1,
			(unsigned)-125, (unsigned)-2147483647);
	printf("ft_printf: %d, printf: %d\n", res1, res2);
	res1 = ft_printf("%x %x %x %X %X %X\n", 1, 125, 2147483647, (unsigned)-1,
			(unsigned)-125, (unsigned)-2147483647);
	res2 = printf("%x %x %x %X %X %X\n", 1, 125, 2147483647, (unsigned)-1,
			(unsigned)-125, (unsigned)-2147483647);
	printf("ft_printf: %d, printf: %d\n", res1, res2);
	res1 = ft_printf("nombre de caracteres print %x\n", 125);
	res2 = printf("nombre de caracteres print %x\n", 125);
	printf("ft_printf: %d, printf: %d\n", res1, res2);
	return (0);
}
